...
export const headerArray: filterConditions [] = [
  { 
    ...
    'nDct5ztDnnObt4KEW2XxGZQNRwp2', '2TXopcELHIb26tlh1gEoJjD9eZD2', 'ot1gOqcz4MZs5VCBB3XaLZmH7423' , 'lTdZbAZenmPW88Ra15Qfbr5ArQ33',
    'Iw1OVpV7jPN9EhABx3j7uJQQcv53', 'jqAb1bpJOONmsfORePtGjjpxWdE2', 'N7obV20LAIgiXYQSFKgr3FKOVMz2' , 'tIdvsSSTLLhPbwp1eR3EAwUYmth1', 
    'Yf0nSGlwj7Ty5b6IDQYo8y1Kb282', 'N1JqQLcCLSfEQntq4Sl4e8IFOSt2', 'TwJV9DwkPbWj7mTRIhaWRFlueSY2' , 'DHibmLGqGOfkjJVd3PRQgbWHspR2',
  ...
  // },
  { 
    header: 'งานเภสัชรายวัน (freelance)',
    filterFlag: true,
    CategorySymbol:"AA",
    loading: true,
    count: 0,
  ...
  { 
    header: 'ร้านยาเดี่ยว (stand alone)',
    filterFlag: true,
